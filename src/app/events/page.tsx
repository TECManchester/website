...
export default function EventsPage() {
  return (
    <>
      ...
      <Section>
        <Card className="border-brand-green/40 bg-brand-green-soft">
          <CardContent className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <ButtonLink href="/im-new" size="lg" className="shrink-0">
              Plan your visit
            </ButtonLink>
          </CardContent>
        </Card>
          ...
          {upcomingEvents.length > 0 ? (
            ...
            <Card className="mt-10">
              <CardContent className="py-14 text-center">
                <CalendarDays className="text-brand-green mx-auto size-10" />
